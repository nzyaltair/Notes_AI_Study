...
- **预训练语言模型**：BERT/GPT 是蒸馏的主要教师模型。参见 [[../02_语言基础模型/00_预训练语言模型_综述|预训练语言模型]]
- **Transformer 架构**：蒸馏针对 Transformer 的注意力机制设计。参见 [[../../B_连接主义与深度学习/08_Transformer与注意力机制/00_Transformer与注意力机制_综述|Transformer 与注意力机制]]
- **大模型蒸馏**：LLM 时代的蒸馏从 BERT 扩展到 GPT 系列。参见 [[15_大模型蒸馏]]
- **量化与低秩分解**：蒸馏后可进一步量化。参见 [[08_量化技术]]、[[06_低秩分解与压缩组合]]
...
- [[03_特征蒸馏]] — 特征蒸馏原理
- [[15_大模型蒸馏]] — LLM 时代的蒸馏
- [[../02_语言基础模型/00_预训练语言模型_综述|预训练语言模型]] — BERT/GPT 预训练模型

...
| 01 | [[H_认知科学与脑启发/01_大脑与认知基础/00_大脑与认知基础_综述\|大脑与认知基础]] | 脑系统、认知神经科学、研究方法、可塑性 | 为计算假设提供机制约束 |
...
| 08 | [[I_高级智能理论与融合方法/08_研究方法与证据评估/00_研究方法与证据评估_综述\|研究方法与证据评估]] | 实验设计、统计推断、基准防污染、可复现性 | 贯穿全部方向的元方法论 |

> I 板块以"统一理论 → 表示与世界理解 → 通用推理 → 能力增长 → 系统涌现与开放演化 → 方法学自检"为主线，研究通用智能的计算原理、边界与可验证架构。其中 08 是元方法论层，为其余全部方向提供实验设计、证据评估与可复现性标准。

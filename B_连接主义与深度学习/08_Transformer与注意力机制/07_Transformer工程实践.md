...
Andrej Karpathy 的最简 GPT 实现（`model.py` ~300 行），是理解 Transformer 内部机制的最佳教学工具。参见 [[../../C_基础模型与通用智能/02_语言基础模型/00_预训练语言模型_综述\|预训练语言模型]]。
...
高性能推理引擎，核心创新是 PagedAttention（将 KV-Cache 管理为虚拟内存页）。参见 [[../../K_AI工程化/03_推理工程/05_vLLM|vLLM]]。
...
- **与 [[../../K_AI工程化/03_推理工程/00_推理工程_综述|推理工程]] 的关系**：推理引擎和 KV-Cache 优化详见该方向
- **与 [[../../K_AI工程化/05_MLOps/00_MLOps综述|MLOps]] 的关系**：模型服务化和部署详见该方向
- **与 [[../../C_基础模型与通用智能/02_语言基础模型/00_预训练语言模型_综述\|预训练语言模型]] 的关系**：从零实现 GPT 的教学实践

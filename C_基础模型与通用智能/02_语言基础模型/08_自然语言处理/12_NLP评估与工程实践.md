...
- **模型量化**：FP16/INT8/INT4 减少内存和加速推理。参见 [[../../../K_AI工程化/03_推理工程/04_量化与模型压缩|量化与模型压缩]]。
- **模型蒸馏**：用大模型蒸馏小模型。参见 [[../../../C_基础模型与通用智能/09_模型压缩与高效推理/01_知识蒸馏基础|知识蒸馏基础]]。
- **批处理**：动态批处理提高吞吐量
- **缓存**：缓存常见查询结果
...
- **与模型部署与工程化的关系**：NLP 模型部署是 MLOps 的重要场景。参见 [[../../../K_AI工程化/05_MLOps/00_MLOps综述|MLOps 综述]]。
- **与大模型推理与优化的关系**：LLM 推理优化直接影响 NLP 系统的延迟和成本。参见 [[../../../K_AI工程化/03_推理工程/00_推理工程_综述|推理工程]]。
- **与 LLM 应用工程的关系**：RAG、提示工程等是 NLP 在大模型时代的新实践。参见 [[D_智能体与自主系统/06_Agent工程系统|Agent 工程系统]]。
- **与知识蒸馏与模型压缩的关系**：蒸馏是 NLP 模型部署的关键技术。参见 [[../../../C_基础模型与通用智能/09_模型压缩与高效推理/01_知识蒸馏基础|知识蒸馏基础]]。

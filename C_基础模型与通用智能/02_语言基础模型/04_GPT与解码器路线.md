...
详见 [[../../06_模型训练与对齐/03_监督微调|监督微调]] 和 [[../../06_模型训练与对齐/04_偏好对齐方法|偏好对齐方法]]。
...
- 从零实现详见 [[06_从零构建GPT]]
- 微调与对齐详见 [[../../06_模型训练与对齐/03_监督微调|监督微调]]、[[../../06_模型训练与对齐/04_偏好对齐方法|偏好对齐方法]]
...
- **效率优化**：推测解码（Speculative Decoding）、量化（[[../../C_基础模型与通用智能/09_模型压缩与高效推理/08_量化技术|量化技术]]）

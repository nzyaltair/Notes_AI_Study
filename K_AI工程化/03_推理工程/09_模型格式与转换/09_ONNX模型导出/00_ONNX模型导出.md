...
- [[../../K_AI工程化/05_MLOps/00_MLOps综述|MLOps 综述]] — ONNX 是部署流水线中的模型交换环节
- [[../../K_AI工程化/05_MLOps/01_模型服务化|模型服务化]] — ONNX Runtime 是主流推理引擎之一
- [[../../C_基础模型与通用智能/09_模型压缩与高效推理/00_模型压缩与高效推理_综述|模型压缩与高效推理]] — 量化技术与 ONNX Opset 13+ 量化算子关联
- [[../../K_AI工程化/05_MLOps/03_容器化与Docker|容器化与 Docker]] — ONNX 模型通过容器部署到不同硬件环境
...
返回 [[00_模型格式与转换|模型格式与转换]] | [[00_推理工程_综述|推理工程]]
